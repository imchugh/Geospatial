...
# Get the data
target = '/mnt/fluxdata/data_Gatum/Gatum_pasture/Spatial_data/CLIP.asc'
...
new_cmap = truncate_colormap(cmap, 0.8, 0)
...
contour = map.contour(xx, yy, data, colors = 'k', alpha = 0.5)
